...
async def song_info(seokey: str = Query(..., description="Full Gaana song URL or just seokey")):
    """
    Accepts a full Gaana song URL or seokey and returns song info JSON.
    Examples:
    /songs/info/?seokey=dhanamali-re
    /songs/info/?seokey=https://gaana.com/song/dhanamali-re
    """
    # Extract seokey from full URL if provided
